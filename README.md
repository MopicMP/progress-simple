...
> Minimal progress bar for loops

[![PyPI version](https://badge.fury.io/py/progress-simple.svg)](https://pypi.org/project/progress-simple/)
...
```bash
pip install progress-simple
```

## Quick Start

```python
from progress_simple import simple
...
from progress_simple import batch
